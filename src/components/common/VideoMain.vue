  ...
  <div class="video-main">
    ...
    <div class="icon clearfix">
      ...
      <span class="play-count"
        >{{ videoDetail.playCount | handlePlayCount }}播放</span
      >
    </div>
    <div class="tags">
      <a
    ...
    <div class="button">
      ...
      <div class="icon-wrapper" @click="likeClick(videoDetailInfo.liked)">
        <i
          ...
          :class="videoDetailInfo.liked ? 'icon-active' : ''"
        ></i>
      ...
      <div class="icon-wrapper" @click="collectionVideo">
        <i
          class="iconfont iconshoucangxuanzhong"
          :class="{ 'icon-active': collectionButton }"
        ></i>
